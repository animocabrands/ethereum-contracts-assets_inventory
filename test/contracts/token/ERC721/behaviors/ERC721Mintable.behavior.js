...
const ReceiverMock = contract.fromArtifact('ERC721ReceiverMock');

function shouldBehaveLikeERC721Mintable(
    {nfMaskLength, mint_ERC721, safeMint_ERC721, batchMint_ERC721, revertMessages},
    ...
    describe('like a mintable ERC721', function () {
        ...
        context('batchMint(address,uint256[])', function () {
            ...
            context('when successful', function () {
                ...
                beforeEach(async function () {
                    this.receipt = await batchMint_ERC721(
                        this.token,
                        owner,
                        tokens,
                        { from: minter }
