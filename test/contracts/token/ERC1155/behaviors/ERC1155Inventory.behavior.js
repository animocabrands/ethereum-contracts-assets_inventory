...
const {shouldBehaveLikeERC1155InventoryMintable} = require('./ERC1155InventoryMintable.behavior');
const {shouldBehaveLikeERC1155InventoryBurnable} = require('./ERC1155InventoryBurnable.behavior');
