                ...
                context('when successful', function () {
                    const batchMint = function () {
                        beforeEach(async function () {
                            ...
                            this.receipt = await safeBatchMint(this.token, this.toWhom, this.tokensToBatchMint.ids, this.tokensToBatchMint.supplies, '0x', { from: minter });
                        });
                ...
                context('when successful', function () {
                    const batchMint = function () {
                        beforeEach(async function () {
                            ...
                            this.receipt = await batchMint_ERC721(this.token, this.toWhom, this.tokensToBatchMint, { from: minter });
                        });
