...
const Mock = contract.fromArtifact("ERC1155InventoryMock");
                ...
                context("when successful", function() {
                    const mint = function() {
                        ...
                        it("should increase the non-fungible token balance of the target account", async function() {
                            (await this.token.balanceOf(this.toWhom)).should.be.bignumber.equal(
                                this.nftBalance.add(One)
                            );
                        });
