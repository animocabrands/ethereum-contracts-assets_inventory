...
// const implementation = require('./implementations/old_ERC1155721Inventory');
// const BurnableInventory = contract.fromArtifact(implementation.contract);

// describe('old_ERC1155721Inventory', function () {
//   const [creator] = accounts;

//   beforeEach(async function () {
//     this.token = await BurnableInventory.new(implementation.nfMaskLength, { from: creator });
//   });
